...
HD_PWD='C:/Users/kelly/OneDrive - Cal Poly Pomona/fall 2024/ece 3300L verilog lab/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_seg_out.tcl
