...
HD_PWD='C:/Users/kelly/OneDrive - Cal Poly Pomona/fall 2024/ece 3300L verilog lab/lab_1/lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_seg_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_seg_out.tcl -notrace
