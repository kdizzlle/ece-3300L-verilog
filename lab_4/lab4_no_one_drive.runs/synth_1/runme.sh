...
HD_PWD='C:/Users/kelly/Documents/class stuff/lab4_no_one_drive/lab4_no_one_drive.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_lights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_lights.tcl
