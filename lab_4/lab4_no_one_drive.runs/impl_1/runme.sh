...
HD_PWD='C:/Users/kelly/Documents/class stuff/lab4_no_one_drive/lab4_no_one_drive.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_lights.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_lights.tcl -notrace
