...
HD_PWD='C:/Users/kelly/OneDrive - Cal Poly Pomona/fall 2024/ece 3300L verilog lab/lab_3/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calc_7seg.tcl -notrace
