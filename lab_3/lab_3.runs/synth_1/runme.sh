...
HD_PWD='C:/Users/kelly/OneDrive - Cal Poly Pomona/fall 2024/ece 3300L verilog lab/lab_3/lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calc_7seg.tcl
