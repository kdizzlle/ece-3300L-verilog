...
HD_PWD='D:/GitHub/ece-3300L-verilog/lab_5/lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combo_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combo_lock.tcl -notrace
