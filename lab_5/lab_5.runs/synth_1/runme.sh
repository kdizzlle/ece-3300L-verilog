...
HD_PWD='D:/GitHub/ece-3300L-verilog/lab_5/lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combo_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combo_lock.tcl
